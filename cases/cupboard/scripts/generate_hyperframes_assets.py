...
VIDEO = ROOT / "videos" / "cupboard-cad-comparison"
ASSETS = VIDEO / "assets"
...
def render_view(method: str, view: str, output: Path) -> None:
    ...
    draw.text((56, 80), f"Shared-spec {VIEW_LABELS[view].lower()} view | orthographic guide", fill=(92, 103, 86, 255), font=font(20))
    ...
    draw.text((56, height - 58), "900W x 450D x 2000H mm | shared-spec orthographic guide", fill=(82, 91, 76, 255), font=font(18))
